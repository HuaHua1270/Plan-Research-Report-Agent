...
from typing import List, Dict, Iterator, AsyncGenerator
...
class SimpleAgent(Agent , BaseModel):
    ...
    def run(self, input_text: str, **kwargs) -> str:
        ...
        if not self.enable_tool_calling or not self.tool_registry:
            ...
            self.add_message(BaseMessage(response_text, "assistant"))
        ...
        if current_iteration >= self.max_tool_iterations and not final_response:
            ...
            # 保存到历史记录
        self.add_message(BaseMessage(input_text, "user"))
        self.add_message(BaseMessage(final_response, "assistant"))
    ...
    def stream_run(self, input_text: str, **kwargs) -> Iterator[str]:
        ...
        # 保存完整对话到历史记录
        self.add_message(BaseMessage(input_text, "user"))
        self.add_message(BaseMessage(full_response, "assistant"))
