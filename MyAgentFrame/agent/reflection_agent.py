...
from ..context import BaseMessage
...
class ReflectionAgent(Agent, BaseModel):
    """
    ...
    def _init_system_prompt(self):
        """根据 config 初始化 system_prompt"""
        if self.system_prompt is None:
            self.system_prompt = default_system_prompt
        self.system_prompt = self.system_prompt + default_system_prompt
    ...
    def run(self, input_text: str, **kwargs) -> str:
        ...
        self.add_message(BaseMessage(final_result, "assistant"))
    ...
    async def arun_stream(
        ...
        try:
            ...
            # 保存到历史
            self.add_message(BaseMessage(input_text, "user"))
            self.add_message(BaseMessage(current_response, "assistant"))
