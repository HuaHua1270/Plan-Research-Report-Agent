...
from .LLMDataFormate import LLMResponse, StreamStats, LLMToolResponse, ToolCall
...
class OpenAIAdapter(BaseChatLLMAdapter):
    """OpenAI兼容接口适配器（默认）
...
class AnthropicAdapter(BaseChatLLMAdapter):
    """Anthropic Claude适配器
...
class GeminiAdapter(BaseChatLLMAdapter):
    """Google Gemini适配器
